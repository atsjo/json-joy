...
const config: StorybookConfig = {
  ...
  webpackFinal: async (config) => {
    ...
    config.resolve.alias = {
      ...
      '@jsonjoy.com/collaborative-input': resolve(__dirname, '../packages/collaborative-input/src'),
      '@jsonjoy.com/collaborative-ace-react/lib': resolve(__dirname, '../packages/collaborative-ace-react/src'),
      '@jsonjoy.com/collaborative-ace-react': resolve(__dirname, '../packages/collaborative-ace-react/src'),
      ...
      '@jsonjoy.com/collaborative-quill-react/lib': resolve(__dirname, '../packages/collaborative-quill-react/src'),
      '@jsonjoy.com/collaborative-quill-react': resolve(__dirname, '../packages/collaborative-quill-react/src'),
      '@jsonjoy.com/collaborative-codemirror/lib': resolve(__dirname, '../packages/collaborative-codemirror/src'),
