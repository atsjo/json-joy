...
): Promise<Uint8Array> => await send(peer1Model.clock.toU8());

export const peer2Reply = async (
  peer2Model: Model<any>,
  message1: Uint8Array,
  send: (message2: Uint8Array) => Promise<Uint8Array>,
): Promise<Uint8Array> => await send(peer2Model.delta(ClockVector.fromU8(message1)).toBinary());
...
export const peer2Finalize = (peer2Model: Model<any>, message3: Uint8Array) =>
