...
const _CodeIcon = makeIcon({set: 'tabler', icon: 'code'});
...
const _H1Icon = makeIcon({set: 'tabler', icon: 'h-1'});
const _H2Icon = makeIcon({set: 'tabler', icon: 'h-2'});
const _H3Icon = makeIcon({set: 'tabler', icon: 'h-3'});
const _H4Icon = makeIcon({set: 'tabler', icon: 'h-4'});
const _H5Icon = makeIcon({set: 'tabler', icon: 'h-5'});
const _H6Icon = makeIcon({set: 'tabler', icon: 'h-6'});
...
const _ImageInPictureIcon = makeIcon({set: 'tabler', icon: 'image-in-picture'});
const _PhotoScanIcon = makeIcon({set: 'tabler', icon: 'photo-scan'});
const _TablerFileIcon = makeIcon({set: 'tabler', icon: 'file'});
const _MathIcon = makeIcon({set: 'tabler', icon: 'math'});
const _TypeIcon = makeIcon({set: 'lucide', icon: 'type'});
...
const _UndoIcon = makeIcon({set: 'lucide', icon: 'undo'});
const _RedoIcon = makeIcon({set: 'lucide', icon: 'redo'});
const _QuoteIcon = makeIcon({set: 'lucide', icon: 'quote'});
const _PilcrowIcon = makeIcon({set: 'lucide', icon: 'pilcrow'});
...
const _CursorTextIcon = makeIcon({set: 'bootstrap', icon: 'cursor-text'});
